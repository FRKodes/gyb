<html>
<head>
    <title>GYB Maquinaria + Miner&iacute;a</title>
</head>
<body>
    ...
    <tbody>
        ...
        <td align='left' bgcolor='#000000' style='text-align:center;'>
            <table width='700' height='300' bgcolor='#000' cellpadding='0' cellspacing='0'>
                <tbody>
                <tr height='100'><td bgcolor='#3cc4f4' style='color:#000000;font-size:large' colspan='3'>GYB Maquinaria + Miner&iacute;a</td></tr>
                <tr height='400'>
                    <td bgcolor='#fff' style='border-left:1px solid #3cc4f4;border-right:1px solid #3cc4f4;'>
                    <table style='font-family:sans-serif, Arial, Helvetica'>
                        ...
                        <td style='text-align:left'>
                            ...
                            <p><b>Ciudad:</b> {{ Input::get('ciudad') }} </p>
