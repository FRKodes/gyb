<div class="col-xs-12 col-sm-8 col-md-6 ml-md-auto mr-md-auto m-bottom-40">
	...
	<h2 class="text-center section-title passion mayus blue">¡llena el formulario para solicitar precio de la maquinaria en venta!</h2>

	<form action="/sendmail-venta-maquinaria" method="post" id="contactFormVentaMaquinaria">
