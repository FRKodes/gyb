...
@section('titlePage', 'Venta de maquinaria pesada. Contamos con maquinaria lista para entrega. Excavadora 320C, Retroexcavadora 580 super m, Vibrocompactador SD100, Camión articulado cat 740, Tractor sobre orugas d155ax.')
@section('description', 'Venta de maquinaria pesada. Contamos con el inventario más completo en equipo de maquinaria pesada y trituración, minería a cielo abierto. ')
...
@section('content')
	...
	<div class="container">
		<div class="row">
			@include('partials.contact-form-venta')
		</div>
	</div>
		...
		$(function(){
			...
			var formSettings = {
				...
				overallSuccess : function(){
					var form    	= $('#contactFormVentaMaquinaria'),
					...
					posting.done(function( data ){
						...
						$('#contactFormVentaMaquinaria')[0].reset();
			...
			var $validate = $('#contactFormVentaMaquinaria').validate(formSettings).data('validate');
		});
	</script>
@stop